...
echo "### Setting up Stable Diffusion Comfy (Instance 2) ###"
log "Setting up Stable Diffusion Comfy Instance 2"
...
if [[ -z "$INSTALL_ONLY" ]]; then
  ...
  PYTHONUNBUFFERED=1 service_loop "python main.py --dont-print-server --highvram --fast $SAGE_FLAG --port 7100" > $LOG_DIR/sd_comfy2.log 2>&1 &
